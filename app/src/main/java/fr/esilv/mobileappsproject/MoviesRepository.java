...
public class MoviesRepository {
    ...
    public void getMovies(int page, String sortBy, final OnGetMoviesCallback callback) {
        ...
        switch (sortBy) {
            case TOP_RATED:
                api.getTopRatedMovies("045b2bb465b354f6ca6c86a080b3794d", LANGUAGE, page)
                        .enqueue(call);
                break;
            case UPCOMING:
                api.getUpcomingMovies("045b2bb465b354f6ca6c86a080b3794d", LANGUAGE, page)
                        .enqueue(call);
                break;
            case POPULAR:
            default:
                api.getPopularMovies("045b2bb465b354f6ca6c86a080b3794d", LANGUAGE, page)
                        .enqueue(call);
                break;
        }
    }
    ...
    public void getMovie(int movieId, final OnGetMovieCallback callback) {
        api.getMovie(movieId, "045b2bb465b354f6ca6c86a080b3794d", LANGUAGE)
    ...
    public void getTrailers(int movieId, final OnGetTrailersCallback callback) {
        api.getTrailers(movieId, "045b2bb465b354f6ca6c86a080b3794d", LANGUAGE)
    ...
    public void getReviews(int movieId, final OnGetReviewsCallback callback) {
        api.getReviews(movieId, "045b2bb465b354f6ca6c86a080b3794d", LANGUAGE)
